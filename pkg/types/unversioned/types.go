...
// LINEAJE: PrivateRegistryImagePuller represents a private registry from which the image needs to be pulled.
type PrivateRegistryImagePuller struct {
	ImagePull func(context.Context, dockerClient.APIClient, string, ImageDetail) error
}
